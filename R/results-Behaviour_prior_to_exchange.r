# SEX IS OF THE INCUBATING PARENT (in time series of the one showing the behaviour
...
{# SETTINGS & DATA
	...
	# define working directory
		 ...
		 wd2 = "/Users/martinbulla/Dropbox/Science/MS/Exchanges_SESA/Analyses/"#"C:/Users/mbulla/Documents/Dropbox/Science/MS/Exchanges_SESA/Analyses/"		 
...
# RESULTS section - Behaviour prior to return of the partner
	{# Distributions
		{# run first
	...
	{# Calls and fly-offs prior to exchange and during regular incubation
			...
			{# Figure 1ab distribution of calls and fly-offs RATE including predictions FOR PAPER
			   {# run first 
			    {# model predictions
				{# calls
			   ...
			   {# plot
				if(PNG == TRUE) {
					png(paste(outdir,"Figure_1ab.png", sep=""), width=1.85+0.6,height=1.5*2,units="in",res=600) 
					}else{
